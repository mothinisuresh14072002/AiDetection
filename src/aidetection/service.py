...
class DetectionService:
    def analyze(self, data: bytes, media_type: MediaType, filename: str = "") -> AnalysisResult:
        return analyze_bytes(data, media_type, filename)

    def analyze_upload(self, data: bytes, filename: str, content_type: str | None) -> AnalysisResult:
